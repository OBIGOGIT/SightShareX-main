...
var Pagination = {
    ...
    Add: function(s, f) {
        for (var i = s; i < f; i++) {
            Pagination.code += '<li class="'+PAGE_BTN_CLS+'"><a style="cursor:pointer">' + i + '</a></li>';
        }
    },
    
    // add last page with separator
    Last: function() {
        Pagination.code += '<li class="'+PAGE_BTN_CLS+'"><a>...</a></li><li class="'+PAGE_BTN_CLS+'"><a style="cursor:pointer">' + Pagination.size + '</a></li>';
    },
    
    // add first page with separator
    First: function() {
        Pagination.code += '<li class="'+PAGE_BTN_CLS+'"><a style="cursor:pointer">1</a></li><li class="'+PAGE_BTN_CLS+'"><a>...</a></li>';
    },
    ...
    Create: function(e) {
        ...
        */
        var html = [
        	'<ul class="pagination pagination-md no-margin"><li class="paginate_button"><a style="cursor:pointer"><span><i class="fa fa-lg fa-angle-left"></i></span></a></li></ul>', // previous button
            '&nbsp;<ul class="pagination pagination-md no-margin"></ul>&nbsp;',  // pagination container
            '<ul class="pagination pagination-md no-margin"><li class="paginate_button"><a style="cursor:pointer"><span><i class="fa fa-lg fa-angle-right"></i></span></a></li></ul>'  // next button
        ];
